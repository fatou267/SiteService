...
if (isset($_SESSION['user']) ) {
   if ($_SESSION['user']['idRole'] == 1) {
    $result = '<a href="AfficherConCode.php" class="btn  btn-outline-success">Voir les anciennes publications </a>';
    $result .='<p>Si tu veux inserer un fichier ou une vidéo merci de déposer le lien sur la partie reservée au texte</p>';
       $result .= '<form class="was-validated" method="post" action="actionConCode.php">
      <div class="mb-3">
    ...
    {
         echo 'Cliquer <a href ="AfficherConCode.php" > ici </a> pour voir les différents conseils sur les codifications ';
