...
if (isset($_SESSION['user']) ) {
   if ($_SESSION['user']['idRole'] == 1) {
    $result = '<a href="AfficherEtranger.php" class="btn  btn-outline-success">Voir les anciennes publications </a>';
    $result .='<p>Si tu veux inserer un fichier ou une vidéo merci de déposer le lien sur la partie reservée au texte</p>';
       $result .= '<form class="was-validated" method="post" action="actionEtranger.php" enctype="multipart/form-data">
    ...
    {
        echo 'Cliquer <a href ="AfficherEtranger.php" > ici </a> pour voir les différentes informations concernant les pré-inscriptions';
