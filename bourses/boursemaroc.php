...
if (isset($_SESSION['user']) ) {
   if ($_SESSION['user']['idRole'] == 1) {
    $result = '<a href="AfficherMaroc.php"  class="btn  btn-outline-success">Voir les anciennes publications </a>';
    $result .='<p>Si tu veux inserer un fichier ou une vidéo merci de déposer le lien sur la partie reservée au texte</p>';
       $result .= '<form class="was-validated" method="post" action="actionMaroc.php" enctype="multipart/form-data">
    ...
    {
       echo 'Cliquer <a href ="AfficherMaroc.php" > ici </a> pour voir les différentes informations concernant les bourses marocaines';
