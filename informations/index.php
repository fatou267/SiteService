...
if (isset($_SESSION['user']) ) {
    ...
    $result = '<a href="AfficherInfo.php" class="btn  btn-outline-success">Voir les anciennes publications </a>';
    $result .='<p>Si tu veux inserer un fichier ou une vidéo merci de déposer le lien sur la partie reservée au texte</p>';
       $result .= '<form class="was-validated" method="post" action="actionInfo.php" enctype="multipart/form-data">
    ...
    {
      echo 'Cliquer <a href ="AfficherInfo.php" > ici </a> pour voir les différentes informations';
    } 
